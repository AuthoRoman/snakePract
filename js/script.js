...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("snake:game_over", function (event) {
    ...
    let modalWindow = document.getElementById(`game-over-modal`);
    let innerTextScore = document.getElementById("yourScore");
    innerTextScore.innerText = score;
